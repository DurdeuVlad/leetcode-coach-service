...
from leetcode_coach_v2.integrations.leetcode import fetch_recent_solved
from leetcode_coach_v2.integrations.telegram import edit_message, send_message
...
async def expire_state() -> None:
    ...
    for batch_id, message_id in expired_messages:
        await edit_message(
            ...
            reply_markup={
                "inline_keyboard": [[
                    {"text": "Extend 24h", "callback_data": f"v2x:{batch_id}"}
                ]]
            },
        )
