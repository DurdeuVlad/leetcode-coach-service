...
```powershell
$env:DATABASE_URL = 'sqlite:///E:/Github2/leetcode-coach-service/.local-v2-live-proof.db'
...
8,131,572,669 chat ID, opaque run state as `TEXT`, and zero leaked advisory
